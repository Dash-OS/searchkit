...
export class FacetFilter<T extends FacetFilterProps> extends SearchkitComponent<
  T,
  any
> {
  ...
  defineAccessor() {
    return new FacetAccessor(this.props.field, this.getAccessorOptions());
  }
  ...
  renderShowMore() {
    ...
    return (
      <FastClick
        handler={() => this.toggleViewMoreOption(option)}
        key="showMore"
      >
        <div
          data-qa="show-more"
          className={this.bemBlocks.container('view-more-action').toString()}
        >
